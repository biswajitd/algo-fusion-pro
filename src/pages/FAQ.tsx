...
By executing this strategy, users can typically earn a minimum of ₹2000 per day using a capital base of approximately ₹5 lakhs.

The approach involves selling both Call (CE) and Put (PE) options at any strike price, provided the premium difference between the two legs does not exceed ₹30.

This setup allows traders to benefit from time decay and range-bound price movement, while maintaining a controlled risk profile.`
        },
        {
